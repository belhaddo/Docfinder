 ...
 * @author badelh
 */
public class Specialities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Speciality> ListSpec = specService.getSpecialityService();
        request.setAttribute( "ListSpec", ListSpec);
        	this.getServletContext().getRequestDispatcher( "/pages/Specialities.jsp" ).forward( request, response );
    }
