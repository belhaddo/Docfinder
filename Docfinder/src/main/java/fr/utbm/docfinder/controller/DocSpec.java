 ...
 * @author badelh
 */
public class DocSpec extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("user") instanceof Doctor) {
            ...
            List<Speciality> ListSpec = doc.getSpecialities();
            ...
            request.setAttribute("desc", doc.getDescs());

            this.getServletContext().getRequestDispatcher("/pages/DocSpec.jsp").forward(request, response);
        } else {
